export const arrows = getSvgPaths('arrows.svg');
export const escondido = getSvgPaths('escondido.svg');
...
export const zamba = getSvgPaths('zamba.svg');
export const remedio = getSvgPaths('remedio.svg');
