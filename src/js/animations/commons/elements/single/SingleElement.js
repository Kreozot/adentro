...
export default class SingleElement {
	 ...
	 */
	animationFunction({lengthMs, beats, direction = DIRECTIONS.FORWARD, startPart = 0, stopPart = 1, figureHands = FIGURE_HANDS.CASTANETAS, isLastElement, stepStyle, firstLeg}) {
